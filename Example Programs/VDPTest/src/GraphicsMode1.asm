...
Gfx1PatternTable        := $0000
Gfx1NameTableEven       := $0800
Gfx1NameTableOdd        := $0C00
Gfx1SpriteAttributes    := $1000
Gfx1SpritePatterns      := $2400
Gfx1ColorTable          := $2000
...
Gfx1SystemInterrupt:    .res 2
Gfx1FrameCount:         .res 1              ; how many frames to skip
Gfx1FrameBufferIdx:     .res 1              ; if 0, use one frame buffer. if 1, use the other in VRAM
...
Gfx1NameTableCopyStart: .res $400
Gfx1NameTableCopyEnd: